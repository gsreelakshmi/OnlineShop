...
//     var baseURL = 'https://firestore.googleapis.com/v1/projects/online-store-9d44e/databases/(default)/documents/Inventory/';
//     var categoryURL = 'https://firestore.googleapis.com/v1/projects/online-store-9d44e/databases/(default)/documents/category/';
...
//                     var productPrice = product.fields.price.doubleValue;
//                     var productCategory = product.fields.category.stringValue;
//                     var imagelink = product.fields.imagelink.stringValue;
...
$(document).ready(function() {
    ...
    $('#submitProductBtn').click(function() {
        var productName = $('#productName').val();
        var productQuantity = $('#productQuantity').val();
        var imagelink = $('#productImage').val(); // Corrected selector for image link
        var productPrice = $('#productPrice').val();
        var productCategory = $('#productCategory').val();
        ...
        if (productName.trim() !== '' && productQuantity !== '' && productPrice !== '') {
            var formData = {
                fields: {
                    ...
                    price: { doubleValue: parseFloat(productPrice) },
                    category: { stringValue: productCategory },
                    imagelink: { stringValue: imagelink } // Include image link in formData
                }
            };
